...
"""
from libr.wtforms import fields as f
from libr.wtforms import Form
from libr.wtforms import validators
from libr.wtforms.ext.django.fields import ModelSelectField
...
def model_form(model, base_class=Form, only=None, exclude=None, field_args=None, converter=None):
    ...
    Create a wtforms Form for a given Django model class::
        ...
        from libr.wtforms.ext.django.orm import model_form
